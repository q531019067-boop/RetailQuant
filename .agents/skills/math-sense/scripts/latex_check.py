...
RULES = [
    {
        ...
        "severity": "error",
        "auto_fix": True,
        "desc": "LaTeX 中的 {,} 会被误解析为分组，应直接用无分隔数字。例如 1{,}000{,}000 → 1000000",
    ...
    },
    {
        ...
        "severity": "error",
        "auto_fix": True,
        "desc": "Markdown 表格内 | 会与列分隔符冲突。将 \\mid 替换为 \\vert，或移出表格使用 $$ 块。",
    ...
    },
    {
        ...
        "severity": "warning",
        "auto_fix": True,
        "desc": "\\Sigma 是大写希腊字母 Σ，求和运算符应为 \\sum。\\sum 在行内和行间自动调整大小，\\Sigma 不会。",
    ...
    },
    {
        ...
        "severity": "error",
        "auto_fix": True,
        "desc": "块级公式 $$...$$ 前后应有空行，且 $$ 应独占一行。正确的格式为：空行 + $$ + 公式内容 + $$ + 空行。",
    },
    {
        ...
        "severity": "warning",
        "auto_fix": True,
        "desc": "行内公式 $ 前不应有空格，$ 后不应紧跟空格（除非是标点）。正确格式为：文字$公式$文字。",
    },
    {
        ...
        "severity": "error",
        "auto_fix": False,
        "desc": "奇数个 $ 表示有未闭合的公式。检查是否漏写了闭合的 $，或者是否将 $$ 误写为 $。",
    },
    {
        "id": "R9_env_pairing",
        "name": "LaTeX 环境未配对",
    ...
    },
    {
        ...
        "severity": "warning",
        "auto_fix": True,
        "desc": "\\mathrm{} 和 \\textrm{} 不支持中文字符（字体缺失），应替换为 \\text{}。",
